...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Kethan Pawar</p>
<p><strong>Email ID:</strong>pawarkethang39aiml@gmail.com</p>
<p><strong>College Name:</strong> Indian Institute of Information Technology, Nagpur</p>
<p><strong>Branch/Specialization:</strong> Computer Science and Engineering</p>
<p><strong>College ID:</strong> BT22CSA004</p>
</div>
...
<p><strong>Trainer Name:</strong> Prof Rajyalaxmi</p>
...
During this course, I strengthened my technical and problem-solving skills through hands-on learning and project development. I gained practical experience in understanding requirements, designing solutions, writing and testing code, and documenting my work. I also improved my understanding of AI, machine learning, software development, teamwork, communication, and real-world project implementation. The course helped me connect theoretical concepts with practical applications and improved my confidence in developing technology-based solutions.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project :</a></strong> &lt;!-- Add project title → --&gt;</p>
...
The LST and SST sessions helped me improve both my technical and professional skills. I learned how to approach problems systematically, communicate ideas clearly, work effectively with others, and take responsibility for completing assigned tasks. The sessions also helped me understand the importance of discipline, teamwork, time management, documentation, and continuous learning. These experiences improved my confidence and helped me become better prepared for real-world professional environments.
---
...
### **Activities Involved**
In the Rims hospital Adilabad, Telangana
- **Blood Donation** – Participated in a blood donation camp and contributed to the community health initiative.
  
 Neatmy house and streets 
...
I would like to sincerely thank my trainer, Prof Rajyalaxmi, for providing guidance and support throughout the course.

I am also grateful to **SURE ProEd for providing me with the opportunity to learn new skills, work on practical projects, and gain valuable professional experience.

I would also like to thank everyone who supported and guided me throughout this learning journey.
